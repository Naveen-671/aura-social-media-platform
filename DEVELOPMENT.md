...
```bash
git remote add encore encore://aura-social-media-platform-nioi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/aura-social-media-platform-nioi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/aura-social-media-platform-nioi/settings/integrations/github)
